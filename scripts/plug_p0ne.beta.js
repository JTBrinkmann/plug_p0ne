    ...
    */
    ...
    module('p0neStylesheet', {
      setup: function(arg$){
        ...
        return loadStyle(p0ne.host + "/css/plug_p0ne.css?r=44");
      }
    });
    /*
    ...
    */
    ...
    module('fimplugTheme', {
      ...
      setup: function(arg$){
        var loadStyle;
        loadStyle = arg$.loadStyle;
        return loadStyle(p0ne.host + "/css/fimplug.css?r=26");
      }
    });
    /*####################################
    #          ANIMATED DIALOGS          #
    ...
    */
    ...
    module('customColors', {
      ...
      settingsExtra: function($wrapper){
        var cc, visible, scope, i$, ref$, len$, role, c, ref1$, ref2$, ref3$, roleName, $row, $cp, $cpDialog, this$ = this;
        cc = this;
        ...
        for (i$ = 0, len$ = (ref$ = this.roles).length; i$ < len$; ++i$) {
          ...
          c = scope[role.name] || ((ref1$ = roomTheme._data) != null ? (ref2$ = ref1$.colors) != null ? (ref3$ = ref2$.chat) != null ? ref3$[role.name] : void 8 : void 8 : void 8) || "#" + role['default'].toString(16);
    ...
    module('p0neSettings', {
      ...
      setup: function(arg$, arg1$, arg2$, oldModule){
        ...
        addListener(API, 'p0ne:moduleDisabled', function(module_){
          ...
          return (ref1$ = module_._$settingsExtra) != null ? ref1$.stop().slideUp(function(){
            return $(this).remove();
          }) : void 8;
        });
        addListener(API, 'p0ne:moduleEnabled', function(module){
          ...
          return this$.settingsExtra(true, module);
        });
    ...
    */
    ...
    module('ponify', {
      ...
      ponifyMsg: function(msg){
        var this$ = this;
        msg.message = msg.message.replace(this.regexp, function(_, pronoun, s, possessive, htmltag, i){
    ...
    */
    ...
    module('fimstats', {
      ...
      setup: function(arg$, lookup){
        ...
        addListener = arg$.addListener, $create = arg$.$create;
        css('fimstats', '.p0ne-fimstats {position: absolute;left: 0;right: 345px;bottom: 54px;height: 1em;padding: 5px 0;font-size: .9em;color: #12A9E0;background: rgba(0,0,0, 0.4);text-align: center;z-index: 6;transition: opacity .2s ease-out;}.p0ne-fimstats-field {display: block;position: absolute;width: 100%;padding: 0 5px;box-sizing: border-box;}.p0ne-fimstats-last { text-align: left; }.p0ne-fimstats-plays, .p0ne-fimstats-once, .p0ne-fimstats-first-notyet { text-align: center; }.p0ne-fimstats-first { text-align: right; }.p0ne-fimstats-field::before, .p0ne-fimstats-field::after,.p0ne-fimstats-first-time, .p0ne-fimstats-last-time, .p0ne-fimstats-once-time {color: #ddd;}#dialog-container .p0ne-fimstats {bottom: 16px;width: 100%;background: rgba(0,0,0, 0.8);}#dialog-container .p0ne-fimstats-first-notyet::before { content: "not played yet!"; color: #12A9E0 }.p0ne-fimstats-first-notyet::before { content: "first played just now!"; color: #12A9E0 }.p0ne-fimstats-once::before { content: "once played by: "; }.p0ne-fimstats-last::before { content: "last played by: "; }.p0ne-fimstats-last-time::before,.p0ne-fimstats-first-time::before,.p0ne-fimstats-once-time::before { content: "("; }.p0ne-fimstats-last-time::after,.p0ne-fimstats-first-time::after,.p0ne-fimstats-once-time::after { content: ")"; }.p0ne-fimstats-plays::before { content: "played: "; }.p0ne-fimstats-plays::after { content: " times"; }.p0ne-fimstats-first::before { content: "first played by: "; }.p0ne-fimstats-first-time,.p0ne-fimstats-last-time,.p0ne-fimstats-once-time {font-size: 0.8em;display: inline;position: static;margin-left: 5px;}');
