  ...
  (function(fn_){
    ...
    */
    ...
    importAll$(jQuery.fn, {
      ...
      binaryGuess: function(checkFn){
        var step, i, goingUp;
        step = this.length;
        if (step === 0 || !checkFn(this[step - 1], step, this[step - 1])) {
          return $();
        } else if (checkFn.call(this[0], 0, this[0])) {
          return this.first();
        }
        i = this.length - 1;
        goingUp = true;
        do {
          step = ~~(step / 2);
          if (checkFn.call(this[i], i, this[i])) {
            goingUp = false;
            i = Math.floor(i - step);
          } else {
            goingUp = true;
    ...
    importAll$(window, {
      ...
      isMessageVisible: function($msg){
        ...
        if ($msg != null && $msg.length) {
          return $cm().height() > (ref$ = $msg.offset().top) && ref$ > 101;
        } else {
          return false;
        }
      },
    ...
    return dataLoadAll({
      ...
      var res$, k, ref$, v, PlaylistItemRow, Dialog, i$, len$, context, ref1$, ref2$, ref3$, cb, app, friendsList, users, user, userID, _, ref4$, e, cm, rR_, onLoaded, dummyP3, ppStop, MAX_IMAGE_HEIGHT, CHAT_WIDTH;
        ...
        try {
          ...
          if (settingsPerCommunity) {
            ...
            module._updateRoom = function(){
              ...
              return dataLoad(settingsKey, _settings, function(err, _settings){
        ...
        function loadingDone(){
          ...
          if (--dependenciesLoading === 0 && 0 === failedRequirements.length) {
            ...
            if (module_) {
              ...
              return console.info(getTime() + " [" + name + "] updated" + wasDisabled, "color: orange");
            } else {
              trigger('moduleLoaded');
              return console.info(getTime() + " [" + name + "] initialized" + wasDisabled, "color: orange");
            }
          }
        }
          ...
          addListener(_$context, 'room:joining', function(){
            ...
            for (i$ in ref$ = p0ne.modules) {
              ...
              if (m.settingsPerCommunity) {
                results$.push(m._updateRoom());
              }
            }
            return results$;
          });
          return addListener(_$context, 'room:joined', function(){
            var i$, ref$, m, results$ = [];
            for (i$ in ref$ = p0ne.modules) {
              m = ref$[i$];
              if (m.settingsPerCommunity && !m.disabled) {
                if (m.loading) {
                  results$.push(m.loading.then(fn$));
                } else {
                  results$.push(m.enable());
                }
              }
            }
            return results$;
      ...
      */
      module('fixStuckDJButton', {
        ...
        setup: function(arg$){
          ...
          return addListener(_$context, 'djButton:update', function(){
            var fixTimeout;
            if ($djbtn.find('.spinner').length === 0) {
              ...
              hasSpinner = true;
              return fixTimeout = sleep(10000, function(){
                return getRoomState().then(function(d){
                  d = d.data[0];
                  if (d.currentDJ === userID || d.waitingDJs.lastIndexOf(userID) !== -1) {
                    if (app != null && app.room.djButton) {
                      return app.room.djButton.hideSpinner();
                    } else {
                      $djbtn.find('.spinner').remove();
                      return $djbtn.find('.icon').show();
                    }
                  }
                });
              });
      ...
      */
      ...
      module('autojoin', {
        ...
        setup: function(arg$){
          ...
          return addListener(API, 'socket:modRemoveDJ', function(e){
      ...
      */
      ...
      module('automute', {
        ...
        setup: function(arg$, automute){
          ...
          streamOff = isSnoozed();
          return addListener(API, 'p0ne:changeMode', onModeChange = function(mode){
            var newStreamOff;
      ...
      module('etaTimer', {
        ...
        setup: function(arg$){
          ...
          css('etaTimer', '.p0ne-eta {width: auto;}#your-next-media>span {width: auto !important;right: 50px;}');
          ...
          $eta = $create('<div class=p0ne-eta>').append($etaText = $('<span class=p0ne-eta-text>ETA: </span>')).append($etaTime = $('<span class=p0ne-eta-time></span>')).mouseover(function(){
            ...
            function updateToolTip(){
              ...
              if (typeof _$context != 'undefined' && _$context !== null) {
                if (p) {
                  return _$context.trigger('tooltip:show', mediaTime(rem) + " remaining + " + p + " × " + mediaTime(avg) + " ø song duration", $etaText);
                } else if (rem) {
            ...
            if (typeof _$context != 'undefined' && _$context !== null) {
              clearInterval(tooltipIntervalID);
              return _$context.trigger('tooltip:hide');
            }
          ...
          updateETA();
          API.on('p0ne:stylesLoaded', function(){
            return requestAnimationFrame(function(){
      ...
      module('boothAlert', {
        ...
        setup: function(arg$, arg1$, arg2$, module_){
          ...
          this.remainingStr = humanTime(_settings.warnXMinBefore);
          isNext = false;
          fn = addListener(API, 'advance waitListUpdate ws:reconnected sjs:reconnected p0ne:reconnected', function(){
            ...
            if (API.getWaitListPosition() === 0) {
              if (_settings.warnOnPrevPlay) {
                ...
                remaining = API.getTimeRemaining() * 1000;
                return warnTimeout = sleep(remaining - _settings.warnXMinBefore, function(){
                  if (remaining > 0) {
        ...
        settingsExtra: function($el){
          var boothAlert, resetTimer, $warning;
          boothAlert = this;
          $("<form>Show notification<br><label><input type=radio name=booth-alert value=on " + (this._settings.warnOnPrevPlay ? 'checked' : '') + "> on preceding song</label><br><label><input type=radio name=booth-alert value=off " + (this._settings.instantWarn ? '' : 'checked') + "> <input type=number value='" + ~~(this._settings.warnXMinBefore * 6000000) / 100 + "' class=booth-alert><br>minute(s) before your play</label></form>").append($warning = $('<div class=warning>')).on('click', 'input:radio', function(){
            if (this.checked) {
              boothAlert._settings.warnOnPrevPlay = this.value === 'on';
              console.log(getTime() + " [boothAlert] updated warnOnPrevPlay to " + boothAlert._settings.warnOnPrevPlay);
            }
          }).on('input', '.booth-alert', function(){
            var this$ = this;
            if (this.value > 0) {
              boothAlert._settings.warnXMinBefore = this.value.min;
              if (resetTimer) {
                $warning.fadeOut();
              ...
              console.log(getTime() + " [boothAlert] updated to " + this.value + "ms");
            } else {
              $warning.fadeIn().text("please enter a valid number >0");
              resetTimer = sleep(2 .min, function(){
                this$.value = ~~(boothAlert._settings.warnXMinBefore * 6000000) / 100;
                resetTimer = 0;
              });
              console.warn(getTime() + " [boothAlert] invalid input for X min", this.value);
            }
          }).appendTo($el);
          return $el.css({
            paddingLeft: 15
              ...
              if (message.user = getUser(uid)) {
                ...
                if (rank === 'regular') {
                  ...
                  if (message.user.friend) {
                    return message.addClass('from-friend');
                  }
                }
              }
            }
      ...
      */
      ...
      module('customChatNotificationTrigger', {
        ...
        setup: function(arg$){
          var addListener, this$ = this;
          addListener = arg$.addListener;
          addListener(_$context, 'chat:plugin', function(d){
            var mentioned;
            if (d.uid !== userID) {
              mentioned = false;
              d.message = d.message.replaceSansHTML(this$.regexp, function(arg$, word){
                mentioned = true;
        ...
        settingsExtra: function($el){
          var $input, this$ = this;
          $('<span class=p0ne-settings-input-label>').text("aliases (comma seperated):").appendTo($el);
      ...
      module('p0neStylesheet', {
        setup: function(arg$){
          ...
          return loadStyle(p0ne.host + "/css/plug_p0ne.css?r=45");
        }
      });
      /*
      ...
      */
      ...
      module('fimplugTheme', {
        ...
        setup: function(arg$){
          var loadStyle;
          loadStyle = arg$.loadStyle;
          return loadStyle(p0ne.host + "/css/fimplug.css?r=27");
        }
      });
      /*####################################
      #          ANIMATED DIALOGS          #
      ...
      module('videoPlaceholderImage', {
        ...
        setup: function(arg$){
          var addListener, $room, maxresdefault, $playbackImg;
          addListener = arg$.addListener;
          $room = $('#room');
          maxresdefault = false;
          $playbackImg = $('#playback-container');
          addListener(API, 'advance', updatePic);
          addListener($playbackImg, 'fail', function(){
            var img;
            if (maxresdefault) {
              maxresdefault = false;
      ...
      */
      ...
      module('customColors', {
        ...
        setup: function(arg$){
          ...
          return loadStyle(p0ne.host + "/vendor/colorpicker/css/colorpicker.css");
        },
        roles: [
          {
            displayName: 'You',
        ...
        settingsExtra: function($wrapper){
          ...
          $('<label class=p0ne-css-override-you><input type=checkbox class=checkbox> "You" overrides other rules</label>').attr('checked', !yellowMod.disabled).appendTo(this.$el).find('input').on('click', function(e){
            ...
            if (this.checked) {
              return yellowMod.enable();
            } else {
              return yellowMod.disable()();
            }
          });
      ...
      */
        ...
        module('customAvatars', {
          ...
          setup: function(arg$, customAvatars){
            ...
            replace(InventoryDropdown.prototype, 'draw', function(d_){
              return function(){
                var html, categories, i$, ref$, len$, avi, category;
                html = "";
                categories = {};
            ...
            */
            ...
            return this.connect('https://ppcas.p0ne.com/_');
            function fn$(oC_){
              return function(){
      ...
      module('p0neSettings', {
        ...
        setup: function(arg$, arg1$, arg2$, oldModule){
          ...
          addListener($body, 'click', '.p0ne-settings-summary', throttle(200, function(e){
            ...
            $s = $(this).parent();
            if ($s.hasClass('open')) {
              $s.removeClass('open').css({
                height: 40
              });
              groupToggles[$s.data('group')] = false;
            } else {
              $s.addClass('open').trigger('p0ne:resize');
              groupToggles[$s.data('group')] = true;
            }
            e.preventDefault();
          }));
          addListener($body, 'p0ne:resize', '.p0ne-settings-group', function(e){
            $(this).css({
          ...
          addListener(API, 'p0ne:moduleEnabled', function(module){
            ...
            if (this$._settings.groupToggles[module.settings]) {
              requestAnimationFrame(function(){
                this$.groups[module.settings].trigger('p0ne:resize');
              });
            }
          });
        ...
        toggleMenu: function(state){
          ...
          this.groupToggles.p0neSettings = state;
        },
        groups: {},
        moderationGroup: $(),
        ...
        settingsExtra: function(autofocus, module, module_){
          ...
          try {
            ...
            if ((ref1$ = module._$settingsExtra) != null) {
              ref1$.remove();
            }
          }
        }
      ...
      module('enableModeratorModules', {
        ...
        setup: function(arg$){
          ...
          return addListener(user_, 'change:role', function(user_, newRole){
            var i$, ref$, m;
          ...
          addListener(API, 'voteUpdate', function(d){
            ...
            if (d.vote === -1 && d.user.uid !== userID) {
              ...
              if (this$._settings.instantWarn) {
                return appendChat($("<div class='cm system'><div class=box><i class='icon icon-chat-system'></i></div><div class='msg text'>" + formatUserHTML(d.user, true) + " meh'd this song!</div></div>"));
              }
            }
          });
          lastAdvance = 0;
      ...
      */
      ...
      module('fimstats', {
        ...
        setup: function(arg$, lookup){
          var addListener, $create, $el, that, ref$, ref1$, ref2$;
          addListener = arg$.addListener, $create = arg$.$create;
          css('fimstats', '.p0ne-fimstats {position: absolute;left: 0;right: 345px;bottom: 54px;height: 1em;padding: 5px 0;font-size: .9em;color: #12A9E0;background: rgba(0,0,0, 0.4);text-align: center;z-index: 6;transition: opacity .2s ease-out;}.video-only .p0ne-fimstats {bottom: 116px;padding-top: 0px;background: rgba(0,0,0, 0.8);}.p0ne-fimstats-field {display: block;position: absolute;width: 100%;padding: 0 5px;box-sizing: border-box;}.p0ne-fimstats-last { text-align: left; }.p0ne-fimstats-plays, .p0ne-fimstats-once, .p0ne-fimstats-first-notyet { text-align: center; }.p0ne-fimstats-first { text-align: right; }.p0ne-fimstats-field::before, .p0ne-fimstats-field::after,.p0ne-fimstats-first-time, .p0ne-fimstats-last-time, .p0ne-fimstats-once-time {color: #ddd;}#dialog-container .p0ne-fimstats {bottom: 16px;width: 100%;background: rgba(0,0,0, 0.8);}#dialog-container .p0ne-fimstats-first-notyet::before { content: "not played yet!"; color: #12A9E0 }.p0ne-fimstats-first-notyet::before { content: "first played just now!"; color: #12A9E0 }.p0ne-fimstats-once::before { content: "once played by: "; }.p0ne-fimstats-last::before { content: "last played by: "; }.p0ne-fimstats-last-time::before,.p0ne-fimstats-first-time::before,.p0ne-fimstats-once-time::before { content: "("; }.p0ne-fimstats-last-time::after,.p0ne-fimstats-first-time::after,.p0ne-fimstats-once-time::after { content: ")"; }.p0ne-fimstats-plays::before { content: "played: "; }.p0ne-fimstats-plays::after { content: " times"; }.p0ne-fimstats-first::before { content: "first played by: "; }.p0ne-fimstats-first-time,.p0ne-fimstats-last-time,.p0ne-fimstats-once-time {font-size: 0.8em;display: inline;position: static;margin-left: 5px;}');
          ...
          addListener(API, 'advance', this.updateStats = function(d){
            ...
            if (d.media) {
              return lookup(d.media).then(function(d){
                return $el.html(d.html);
              }).fail(function(err){
                return $el.html(err.html);
              });
            } else {
              return $el.html("");
            }
              ...
              return _.defer(function(){
                ...
                if ((ref$ = d.dialog.options) != null && ref$.media) {
                  ...
                  return lookup(d.dialog.options.media.toJSON()).then(function(d){
                    return $('#dialog-preview').after($('<div class=p0ne-fimstats>').html(d.html));
                  });
                }
              });
            });
          ...
          addListener(API, 'p0ne:moduleEnabled p0ne:moduleUpdated', function(m){
            if (m.name === 'p0neSettings') {
              return $('#p0ne-menu').css({
                bottom: 54 + 21
              });
            }
          });
        ...
        module: function(media){
          ...
          def = $.Deferred();
          $.getJSON("https://fimstats.anjanms.com/_/media/" + media.format + "/" + media.cid + "?key=" + p0ne.FIMSTATS_KEY).then(function(d, arg$, res){
            d = d.data[0];
            if (res.responseText.hasAny(['<', '>'])) {
              chatWarn(d.text = d.html = "fimstats data might contain malicious code (" + media.format + "/" + media.cid + ")", "fimstats warning");
              def.reject();
              return;
            }
            if (d.firstPlay.time !== d.lastPlay.time) {
              ...
              d.html = "<span class='p0ne-fimstats-field p0ne-fimstats-last p0ne-name' data-uid=" + d.lastPlay.id + ">" + d.lastPlay.user + "<span class=p0ne-fimstats-last-time>" + ago(d.lastPlay.time * 1000) + "</span></span><span class='p0ne-fimstats-field p0ne-fimstats-plays'>" + d.plays + "</span><span class='p0ne-fimstats-field p0ne-fimstats-first p0ne-name' data-uid=" + d.firstPlay.id + ">" + d.firstPlay.user + "<span class=p0ne-fimstats-first-time>" + ago(d.firstPlay.time * 1000) + "</span></span>";
            } else {
              d.text = "once played by " + d.firstPlay.user;
              d.html = "<span class='p0ne-fimstats-field p0ne-fimstats-once'>" + d.firstPlay.user + "<span class=p0ne-fimstats-once-time>" + ago(d.firstPlay.time * 1000) + "</span></span>";
            }
